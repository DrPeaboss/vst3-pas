...
const
  CID_HelloProcessor:TGuid  = '{4BBC1D96-BDB1-4068-94A0-711E5B3CE924}';
  CID_HelloController:TGuid = '{532CB6F1-FFB5-4EDC-A00A-0190B420B58D}';
...
type
  ...
  public
    ...
    function CreateView(name:FIDString):IPlugView unsafe; override; winapi;
  end;
...
var
  [unsafe]changes:IParameterChanges;
  [unsafe]ParamQueue:IParamValueQueue;
...
begin
  ...
  begin
    ...
    begin
      Pointer(ParamQueue):=changes.GetParameterData(i);
...
function THelloController.CreateView(name:FIDString):IPlugView unsafe; winapi;
var
  View:THelloPlugView;
begin
  Result:=nil;
...
begin
  ...
  FClassProcessor.Init(CID_HelloProcessor,kManyInstances,kDistributable,kVstAudioEffectClass,
    'Fx','HelloVst3Delphi','Peacoor Zomboss','0.0.1',kVstVersionString);
  FClassController.Init(CID_HelloController,kManyInstances,0,kVstComponentControllerClass,
    '','HelloVst3Delphi','Peacoor Zomboss','0.0.1',kVstVersionString);
end;
