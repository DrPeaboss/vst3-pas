...
type
  ...
  public
    ...
    function CreateView(name:FIDString):IPlugView; virtual; winapi;
...
begin
  if GetInterfaceByStr(iid.ToString(), obj) then
  begin
    _AddRef; // Important !
    Result:=kResultOk;
  end
...
begin
  if FHostContext<>nil then // _Release it
  begin
    FHostContext._Release;
    FHostContext:=nil;
  end;
  Result:=kResultOk;
end;
...
function TVEditController.CreateView(name:FIDString):IPlugView; winapi;
begin
  Result:=nil;
end;
